...
public class CoAttachmentDTO {
	...
	public CoAttachmentDTO() {}

	public CoAttachmentDTO(int memFileNo, int memNo, String memFileName, String memFileOriginalName, String filePath,
			String fileKinds) {
		super();
	...
	public String toString() {
		return "CoAttachmentDTO [memFileNo=" + memFileNo + ", memNo=" + memNo + ", memFileName=" + memFileName
