...
@WebServlet("/personal/notice/detail")
public class PersonalNoticeDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String path="";
		path = "/WEB-INF/views/member/personal/personalNoticeDetail.jsp";
