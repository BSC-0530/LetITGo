package com.itsme.letitgo.admin.board.notice.model.dto;

import java.sql.Date;

public class PersonalInfoPolicyDTO {
	...
	public PersonalInfoPolicyDTO() {}

	public PersonalInfoPolicyDTO(int postNo, String postTitle, String postContent, Date postRegistrationDate,
			String postKinds, Date postModifiedDate, String postExposureStatus, int managerMemberNo) {
		super();
		this.postNo = postNo;
	...
	public String toString() {
		return "PersonalInfoPolicyDTO [postNo=" + postNo + ", postTitle=" + postTitle + ", postContent=" + postContent
