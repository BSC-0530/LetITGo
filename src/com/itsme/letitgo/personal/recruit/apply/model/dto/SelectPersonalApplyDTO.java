...
public class SelectPersonalApplyDTO {
	...
	public SelectPersonalApplyDTO() {}

	public SelectPersonalApplyDTO(int jobPostNo, int resumeNo, String jobPostTitle, String coComName,
			Date jobPostEnrollDate, Date jobPostDeadLine, String jobPostApplyingStatus, String jobPostBrowesStatus,
			String jobPostApplyingKinds) {
		super();
	...
	public String toString() {
		return "SelectPersonalApplyDTO [jobPostNo=" + jobPostNo + ", resumeNo=" + resumeNo + ", jobPostTitle="
				+ jobPostTitle + ", coComName=" + coComName + ", jobPostEnrollDate=" + jobPostEnrollDate
				+ ", jobPostDeadLine=" + jobPostDeadLine + ", jobPostApplyingStatus=" + jobPostApplyingStatus
