...
<!-- 사이드바 -->
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="jp_listing_tabs_wrapper">
								...
								<!-- 이거는 이제 정보뜨는 칸 -->
								<!-- 데이터 테이블 내역모음 -->
								<table id="self_introduction_item"
									...
									<thead>
										...
										<tbody align="center">
									<c:forEach var="controllSelfIntroductionItem"
										items="${ requestScope.selfIntroductionItemList }">


											<tr>
												<td id="selfIntroItemNo"><c:out
														value="${ controllSelfIntroductionItem.selfIntroItemNo }" /></td>
	...
	<script>
		$(document).ready(function() {
			$('#self_introduction_item').DataTable();
		});
	</script>
