...
<!-- 					</div> -->
<!-- 				</div> -->
<%-- 		<form action="${ pageContext.servletContext.contextPath }/personalinfo/policy/detailview" method="post" onsubmit="check();">	 --%>
...
<%-- 									 placeholder="번호 : ${ detailView.postNo }" readonly="readonly"> --%>
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 						<div class="col-lg-8 col-md-6 col-sm-12 col-xs-12"> -->
<!-- 							<div class="jp_contact_inputs_wrapper jp_contact_inputs1_wrapper"> -->
<!-- 								<i class="fa fa-pencil-square-o"></i><input name="managerMemberNo" -->
<%-- 									placeholder="관리자자번호 : "value="${detailView.managerMemberNo }"> --%>
<!-- 							</div> -->
<!-- 						</div> -->
...
<%-- 									value="${ detailView.postTitle }" readonly="readonly"> --%>
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 						<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"> -->
<!-- 							<div class="jp_contact_inputs_wrapper jp_contact_inputs3_wrapper"> -->
<!-- 								<i class="fa fa-pencil-square-o"></i><input name="postRegistrationDate" -->
<%-- 									 value="${ detailView.postRegistrationDate }" readonly="readonly"> --%>
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 						<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"> -->
<!-- 							<div class="jp_contact_inputs_wrapper jp_contact_inputs3_wrapper"> -->
<%-- 						<c:choose> --%>
<%-- 							<c:when test="${empty detailView.postModifiedDate } }"> --%>
<!-- 								<i class="fa fa-pencil-square-o"> -->
<!-- 								</i><input name="postModifiedDate"placeholder="수정일: 없음" readonly="readonly"> -->
<%-- 							</c:when> --%>
<%-- 							<c:otherwise> --%>
<!-- 								<i class="fa-pencil-square-o"> -->
<%-- 								</i><input name="postModifiedDate" value="${ detailView.postModifiedDate }" readonly="readonly"> --%>
<%-- 							</c:otherwise> --%>
<%-- 						</c:choose> --%>
<!-- 							</div> -->
<!-- 						</div> -->
...
<%-- 									value="${ detailView.postExposureStatus }" readonly="readonly"> --%>
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> -->
