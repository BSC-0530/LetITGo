...
<!-- body시작 -->
		<form action="${ pageContext.servletContext.contextPath }/member/personal/modifyinfo" method="post">
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="jp_listing_tabs_wrapper">
								<label style="font-size:30px;">개인회원 정보 수정</label><br>
								<img alt="대표이미지없음" src="" style="width: 300px; height:300px">
														<!--                             이거는 이제 정보뜨는 칸 -->
								<div class="tab-pane fade in active register_left_form"id="contentOne-1">
									...
									<div class="row">
										...
										<div class="form-group col-md-6 col-sm-6 col-xs-12">
											<input type="text" name="personalName" placeholder="이름" style="text-transform: lowercase;">
										</div>
										<div class="form-group col-md-6 col-sm-6 col-xs-12">
											<input type="text" name="personalPhone"  placeholder="phone" style="text-transform: lowercase;">
										</div>
									</div>
								</div>
							<div class="jp_listing_tabs_wrapper">
					...
					<button type="reset" class="btn btn-info" id="coInfoChange" style="float: right; background: red; border: 0px; margin: 5px">취소</button>
					<button type="submit" class="btn btn-info" id="coInfoChange" style="float: right; background: skyblue; margin: 5px">확인</button>
				</div>
			</div>
		</div>
	</div>
