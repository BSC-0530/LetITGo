...
<!--   				111~114번이 있어야 사이드바 옆에 내용이 입력됨       -->
							...
							<div class="jp_listing_tabs_wrapper">
								...
								<div class="tab-pane fade in active register_left_form"
									...
									<div class="row">
										...
										<!--Form Group-->
										<div class="form-group col-md-6 col-sm-6 col-xs-12">
											<input type="text" name="field-name" value="" placeholder=${ site } readonly>
										</div>
										<!--Form Group-->
										<div class="form-group col-md-6 col-sm-6 col-xs-12">
            	...
            	<!-- end --> 
						 <button onclick="infoChange();" class="btn btn-info" id="coInfoChange" style=" float: right;" >기업 정보 변경</button>
            	</div>
			</div>
		</div>
	</div>
