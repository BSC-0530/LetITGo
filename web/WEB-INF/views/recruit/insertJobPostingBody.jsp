...
<body>
    ...
    <body>
    <c:out value="${ requestScope.jobNameList }"></c:out>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" > 
                            ...
                            <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12" style="width: 100%;" >
                                <div class="jp_adp_form_wrapper" >
                                    ...
                                    <c:forEach var="jobNameList" items="${ requestScope.jobNameList }" varStatus="status">
                                    	<input style="width: 20px; height: 20px; border: 1px;" type="radio" id="${ jobNameList.jobNo }" value="${ jobNameList.jobNo }" name="jobName">
                            ...
                            <div class="col-lg-3 col-md-3 col-md-3 col-xs-12" style="width: 100%; margin-top: 30px;">
                                ...
                                <select id="jobPostMinExperience" >
                                    <option value="">--최소경력--</option>
                                </select>
                                <label>~</label>
                                <select id="jobPostMaxExperience" >
                            ...
                            <div class="col-lg-3 col-md-3 col-md-3 col-xs-12" style="width: 100%;">
                                <div class="jp_adp_textarea_main_wrapper">
                                    ...
                                    <textarea rows="7" placeholder="공고 내용을 입력하세요*"  name="selfIntroItemContent" required></textarea>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <button class="recruit" id="sendResume">이력서 등록</button>
