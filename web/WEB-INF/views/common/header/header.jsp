...
<body>
	...
	<div class="gc_main_menu_wrapper">
		<div class="jp_top_header_right_cont">
			<ul>
				<li><a href="#" align="center"
					style="background: red; margin-right: 30px; border-radius: 10px; width: 100px">로그아웃</a></li>
			</ul>
		</div>
						...
						<div class="mainmenu">
							<ul class="float_left">
								...
								<li class="has-mega gc_main_navigation">
									<%-- <a href="${ pageContext.servletContext.contextPath }/personal/memberInfo/select" class="gc_main_navigation" class="gc_main_navigation">동기</a> --%>
									<a
									href="${ pageContext.servletContext.contextPath }/personalMyInfo"
									class="gc_main_navigation" class="gc_main_navigation">동기2</a>
								</li>
							</ul>
						</div>
					</div>
	...
	<div class="gc_main_menu_wrapper">
		<div class="jp_top_header_right_cont">
			<ul>		
				<li><a href="${ pageContext.servletContext.contextPath }/loginPage" align="center" style="background: rgb(102,114,173); margin-right: 30px; border-radius: 10px; width: 100px">Log In</a></li>
			</ul>
		</div>
		<div class="container-fluid">
			<div class="row">
